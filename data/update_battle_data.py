...
#for target_season in range(19):
# Decode
names, types, moves, items, abilities = {}, {}, {}, {}, {} 
with open(dir+'/codelist/nameCode.json', encoding='UTF-8') as fin:
    names = json.load(fin)
with open(dir+'/codelist/typeCode.json', encoding='UTF-8') as fin:
    types = json.load(fin)
with open(dir+'/codelist/moveCode.json', encoding='UTF-8') as fin:
    moves = json.load(fin)
with open(dir+'/codelist/itemCode.json', encoding='UTF-8') as fin:
    items = json.load(fin)
with open(dir+'/codelist/abilityCode.json', encoding='UTF-8') as fin:
